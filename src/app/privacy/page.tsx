...
const PrivacyPolicyPage = () => {
  return (
    <main className="max-w-7xl mx-auto privacy-page">
      <div>
        <div className="p-5">
          <p className="text-2xl font-bold">Privacy policy for TBCheck</p>
        </div>
        <hr />
      </div>
      ...
      <div className="policy-container">
        ...
        <ul>
          ...
          <li>
            ...
            "Us" or "Our" in this Agreement) refers to Faculty of Computer
            Science at Universitas Indonesia, UI Depok Campus, West Java.
          </li>
          <li>
      ...
      <div className="policy-container">
        ...
        <p>
          ...
          identify You. Personally identifiable information when You register to
          Our Service may include, but is not limited to: full name, age group,
          gender, email address, phone number, demographic location, faculty and
          university name.{" "}
        </p>
        <p>
          We may also ask You to provide personal health data related to TBC
          disease when You use Our Service, such as list of symptoms, travel
          history, list of close contacts, and TBC test information (date, type,
          and result of test).
        </p>
        <h3>Usage Data</h3>
        <p>Usage Data is collected automatically when using the Service.</p>
        <p>
          When You access the Service by a mobile device, We may collect certain
        ...
        <p>
          ...
          access the Service by a mobile device.
        </p>
      ...
      <div className="policy-container">
        ...
        <ul>
          <li>By email: widiaresti@cs.ui.ac.id</li>
        </ul>
      </div>
    </main>
  );
